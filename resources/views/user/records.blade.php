            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        @if (!Auth::guest())
                        <!-- sidebar here -->
                        <button type="button" id="formButton">+ add record </button>
                        <br><br>
                        ...
                        <div id="apear">
                                    ...
                                    <form name="add-record-form" id="add-record-form" method="post" action="{{ url('store-record-form') }}">
                                      @csrf  
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Записи</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Таблицы</a></li>
                                            <li class="breadcrumb-item active">Таблица Записей</li>
                                        </ol>
                                    </div>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                             ...
                                             <tr>
                                               ...
                                               <td><a href="{{ url('record.delete/'.$record->id) }}"><i class="fa fa-trash"></i></a></td>
                                             </tr>  
                                             @endforeach   
