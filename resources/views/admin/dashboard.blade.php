...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | Umai - Admin & Dashboard Template</title>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('user.widgets.add_student') }}" class=" waves-effect">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Umai</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <p class="text-truncate font-size-14 mb-2">Расходы</p>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <p class="text-truncate font-size-14 mb-2">Прибыль</p>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <p class="text-truncate font-size-14 mb-2">Новый пользователь</p>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="card">
                                    <div class="card-body pb-0">
                                        ...
                                        <h4 class="card-title mb-4">Добавленный пользователь</h4>
